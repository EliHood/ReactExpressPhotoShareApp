...
class SignUp extends Component{
    ...
    render(){
        ...
        const validation = {
            validation: !this.state.formData.email ||!this.state.formData.username || !this.state.formData.password || !this.state.formData.passwordConf ||
                        this.state.formData.password.length <= 6  || this.state.formData.passwordConf.length <= 6 
        }
        return(
            <div>
